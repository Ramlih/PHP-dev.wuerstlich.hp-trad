<?php
?>
<div id="dse" class="art-footer-item box-shadow box-bgc">
...
<p>Au&szlig;erdem haben Sie das Recht, unter bestimmten Umst&auml;nden
     ...
     Datenschutzerkl&auml;rung unter &bdquo;Recht auf Einschr&auml;nkung der
...
<p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser
     Website ist:</p>
<p>
     W&uuml;rstlich<br /> Sebastian Ebeling<br /> Berliner Chaussee 48 - 50<br />
     39114 Magdeburg
</p>

<p>
     Telefon: +49 173 2398011<br /> E-Mail: info@wuerstlich.de
</p>
...
<p>Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung
     ...
     &Uuml;bertragung der Daten an einen anderen Verantwortlichen verlangen,
...
<ul>
     ...
     <li>Wenn die Verarbeitung Ihrer personenbezogenen Daten
          ...
          L&ouml;schung die Einschr&auml;nkung der Datenverarbeitung verlangen.</li>
     <li>Wenn wir Ihre personenbezogenen Daten nicht mehr ben&ouml;tigen,
          Sie sie jedoch zur Aus&uuml;bung, Verteidigung oder Geltendmachung von
...
<p>Teilweise k&ouml;nnen auch Cookies von Drittunternehmen auf Ihrem
...
<p>Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu
     ...
     Interesse an der einheitlichen Darstellung des Schriftbildes auf seiner
     Webseite. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B.
     eine Einwilligung zur Speicherung von Cookies), erfolgt die
     Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit.
     a DSGVO; die Einwilligung ist jederzeit widerrufbar.</p>
<p>Wenn Ihr Browser Web Fonts nicht unterst&uuml;tzt, wird eine
...
<p>Diese Website nutzt &uuml;ber eine API den Kartendienst Google Maps.
     Anbieterin ist die Google Ireland Limited (&bdquo;Google&ldquo;),
     Gordon House, Barrow Street, Dublin 4, Irland.</p>
<p>Um den Datenschutz auf dieser Website zu gew&auml;hrleisten, ist
     Google Maps deaktiviert, wenn Sie diese Website das erste Mal betreten.
     Eine direkte Verbindung zu den Servern von Google wird erst
     hergestellt, wenn Sie Google Maps selbstst&auml;ndig aktivieren
     (Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO). Auf diese Weise wird
     verhindert, dass Ihre Daten schon beim ersten Betreten der Seite an
     Google &uuml;bertragen werden.</p>
<p>Nach der Aktivierung wird Google Maps Ihre IP-Adresse speichern.
     Diese wird anschlie&szlig;end in der Regel an einen Server von Google
     in den USA &uuml;bertragen und dort gespeichert. Der Anbieter dieser
     Seite hat nach der Aktivierung von Google Maps keinen Einfluss auf
...
<p>Wenn Sie eine Website besuchen, auf der OpenStreetMap eingebunden
     ist, werden u. a. Ihre IP-Adresse und weitere Informationen &uuml;ber
     ...
     Browser. Das sind Textdateien, die auf Ihrem Computer gespeichert
     werden und die eine Analyse der Benutzung der Website durch Sie
     erm&ouml;glichen. Sie k&ouml;nnen die Speicherung der Cookies durch
     ...
     nicht s&auml;mtliche Funktionen dieser Website vollumf&auml;nglich
     werden nutzen k&ouml;nnen.</p>
<p>
     ...
     Datenschutzerkl&auml;rung von OpenStreetMap unter folgendem Link: <a
...
<p>Die Nutzung von OpenStreetMap erfolgt im Interesse einer
     ...
     DSGVO dar. Sofern eine entsprechende Einwilligung abgefragt wurde (z.
